...
class DataBaseSettings(BaseSettings):
    ...
    db_database: str = "triotea-fastapi"
    db_echo: bool = True
...
class NCBISettings(BaseSettings):
    """
    NCBI E-utilities API配置
    """

    ncbi_api_key: str = ""
    ncbi_tool_name: str = "MedAbsTrack"
    ncbi_email: str = "example@example.com"
...
class UploadSettings:
    ...
    DOWNLOAD_PATH = "io/download_path"
...
# NCBI配置
NCBIConfig = get_config.get_ncbi_config()
# 代码生成配置
